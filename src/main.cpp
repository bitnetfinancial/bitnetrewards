...
uint256 hashGenesisBlock("0xea39e83a9e30602c60df6a7a0a6b6556a6e8c9fd83a36436fb23faf61d8f938c");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // bitnetrewards: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "bitnetrewards Signed Message:\n";
...
{
    // bitnetrewards: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 500000); // bitnetrewards: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // bitnetrewards: 3.5 days
static const int64 nTargetSpacing = 150; // bitnetrewards: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // bitnetrewards: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // bitnetrewards: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // bitnetrewards: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xddfb261e6353cd7abb8f70708ab20c94cbff0e178669040877032223fe8d1cd7");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "Rewarding you with the finer things in life!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("74b7cd5609b4344730d7f04779107a589364fe71f927687003a8ce972afd57c4686529c2a30eed6c365e5775d314da6706bc83b10c08957700dcda5268c94991a7") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1514842760;
        block.nBits    = 504365644;
        block.nNonce   = 1654896398;

        if (fTestNet)
        {
            block.nTime    = 1514842760;
            block.nNonce   = 1323315195;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x5d2b772726afd99bcb3f572a507aa78357a37362829bbfb98060914909b25972"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // bitnetrewards: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("bitnetrewardsMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("bitnetrewardsMiner : ProcessBlock, block not accepted");
    }
